...
export default function PayrollClient({
  ...
  return (
    <div className="w-full min-h-screen pb-16 space-y-8">
      {/* Header Banner */}
      <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-zinc-900 via-zinc-900/90 to-zinc-950 border border-zinc-800/80 p-6 md:p-8 shadow-2xl">
        ...
        <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
          ...
          <div className="flex flex-wrap items-center gap-3">
            ...
            <Link
              ...
              className="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-zinc-800/60 hover:bg-zinc-800 text-zinc-300 text-sm font-medium border border-zinc-700/40 transition shadow-sm"
            >
        ...
        {/* Info Grid Pills */}
        <div className="relative z-10 grid grid-cols-2 sm:grid-cols-4 gap-3 mt-6 pt-6 border-t border-zinc-800/60">
      ...
      {previousMonthData && (
        <div className="relative overflow-hidden rounded-2xl border transition-all duration-300">
          {!previousMonthData.isClaimed ? (
              ...
              <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-6">
                ...
                <div className="flex flex-col sm:flex-row items-center gap-3 w-full lg:w-auto">
                  <button
                    ...
                    disabled={isClaiming}
                    className="w-full sm:w-auto inline-flex items-center justify-center gap-2.5 px-6 py-3.5 rounded-xl bg-gradient-to-r from-amber-500 to-yellow-500 hover:from-amber-400 hover:to-yellow-400 text-zinc-950 font-black text-sm tracking-wide shadow-lg shadow-amber-500/25 transition-all transform active:scale-95 disabled:opacity-50"
                  >
                    {isClaiming ? (
                      <>
            ...
            <div className="p-4 md:p-5 bg-zinc-900/70 border-zinc-800 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
              ...
              <button
                ...
                className="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-zinc-800 hover:bg-zinc-700 text-zinc-200 text-xs font-semibold border border-zinc-700 transition"
              >
      ...
      <div className="space-y-4">
        ...
        <div className="rounded-2xl bg-zinc-900/90 border border-zinc-800 p-6 space-y-6 shadow-xl">
          {/* Summary Row */}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          {/* 1. Tiket Support */}
          <div className="rounded-xl bg-zinc-900/80 border border-zinc-800 p-4 space-y-3 hover:border-zinc-700 transition">
      ...
      <div className="space-y-4 pt-4">
        ...
        {historyRecords && historyRecords.length > 0 ? (
          <div className="overflow-hidden rounded-2xl bg-zinc-900/90 border border-zinc-800 shadow-xl">
            <div className="overflow-x-auto">
              <table className="w-full text-left text-sm">
                <thead className="bg-zinc-950/60 text-xs font-semibold text-zinc-400 uppercase tracking-wider border-b border-zinc-800">
                  <tr>
                ...
                <tbody className="divide-y divide-zinc-800/60">
                  {historyRecords.map((r: any) => (
                    ...
                    >
                      ...
                      <td className="px-6 py-4 font-mono text-xs text-amber-400 whitespace-nowrap">
                        {r.claimedTrxId || "-"}
                      </td>
                      ...
                      <td className="px-6 py-4 text-right">
                        <button
                          ...
                          className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-zinc-800 hover:bg-zinc-700 text-zinc-200 text-xs font-semibold border border-zinc-700 transition"
                        >
                          <Receipt className="w-3.5 h-3.5 text-amber-400" />
                          Slip
                        </button>
      ...
      {selectedReceipt && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm animate-in fade-in">
          <div className="relative w-full max-w-lg rounded-2xl bg-zinc-900 border border-zinc-700 p-6 md:p-8 shadow-2xl space-y-6">
              ...
              <div className="space-y-2">
                ...
                <div className="p-3 rounded-xl bg-zinc-950/40 border border-zinc-800/60 space-y-1.5 text-xs">
                  <div className="flex justify-between text-zinc-400">
                    ...
                    <span className="font-bold text-white">10.000 NC</span>
                  </div>
                  <div className="flex justify-between text-zinc-400">
